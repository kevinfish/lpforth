...
\ save as dis486-1.f for soft link Wed Apr 26 00:29:32 2000
...
: nfa-count ( nfa -- adr len )
        dup c@ 63 AND SWAP OVER - SWAP ;
...
CREATE NEXT-SEQ 3 c, $ad c, $ff c, $e0 c,
...
: ((")) ( -- counted-string ) \ get counted string and advance next word
        1 nr@ dup c@ 1 nr@ + 2+ 1 nr! ;
...
\                $00 of   gp6                             endof
\                $01 of   gp7                             endof
\                $02 of   .s" lar     " 1 to size r,r/m   endof
\                $03 of   .s" lsl     " 1 to size r,r/m   endof
\                $06 of   .s" clts    "                   endof
\                $08 of   .s" invd    "                   endof
\                $09 of   .s" wbinvd  "                   endof
\                $20 of   mrc                             endof
\                $21 of   mrd                             endof
\                $22 of   mcr                             endof
\                $23 of   mdr                             endof
\                $24 of   mrt                             endof \ obsolete
\                $26 of   mtr                             endof \ obsolete
\                $30 of   .s" wrmsr   "                   endof
\                $31 of   .s" rdtsc   "                   endof
\                $32 of   .s" rdmsr   "                   endof
\                $80 of   .s" jo      " rel16/32          endof
\                $81 of   .s" jno     " rel16/32          endof
\                $82 of   .s" jc      " rel16/32          endof
\                $83 of   .s" jnc     " rel16/32          endof
\                $84 of   .s" jz      " rel16/32          endof
\                $85 of   .s" jne     " rel16/32          endof
\                $86 of   .s" jbe     " rel16/32          endof
\                $87 of   .s" ja      " rel16/32          endof
\                $88 of   .s" js      " rel16/32          endof
\                $89 of   .s" jns     " rel16/32          endof
\                $8A of   .s" jpe     " rel16/32          endof
\                $8B of   .s" jpo     " rel16/32          endof
\                $8C of   .s" jnge    " rel16/32          endof
\                $8D of   .s" jge     " rel16/32          endof
\                $8E of   .s" jng     " rel16/32          endof
\                $8F of   .s" jg      " rel16/32          endof
\                $90 of   .s" seto    byte " r/m8         endof
\                $91 of   .s" setno   byte " r/m8         endof
\                $92 of   .s" setc    byte " r/m8         endof
\                $93 of   .s" setnc   byte " r/m8         endof
\                $94 of   .s" setz    byte " r/m8         endof
\                $95 of   .s" setnz   byte " r/m8         endof
\                $96 of   .s" setbe   byte " r/m8         endof
\                $97 of   .s" seta    byte " r/m8         endof
\                $98 of   .s" sets    byte " r/m8         endof
\                $99 of   .s" setns   byte " r/m8         endof
\                $9A of   .s" setp    byte " r/m8         endof
\                $9B of   .s" setnp   byte " r/m8         endof
\                $9C of   .s" setl    byte " r/m8         endof
\                $9D of   .s" setge   byte " r/m8         endof
\                $9E of   .s" setle   byte " r/m8         endof
\                $9F of   .s" setg    byte " r/m8         endof
\                $A0 of   .s" push    fs "                endof
\                $A1 of   .s" pop     fs "                endof
\                $A2 of   .s" cpuid      "                endof
\                $A3 of   .s" bt      " 1 to size r/m,r   endof
\                $A4 of   .s" shld    " r/m,r imm8        endof
\                $A5 of   .s" shld    " r/m,r .s" , cl"   endof
\                $A8 of   .s" push    gs "                endof
\                $A9 of   .s" pop     gs "                endof
\                $AA of   .s" rsm     "                   endof
\                $AB of   .s" bts     " 1 to size r/m,r   endof
\                $AC of   .s" shrd    " r/m,r imm8        endof
\                $AD of   .s" shrd    " r/m,r .s" , cl"   endof
\                $AF of   .s" imul    " r,r/m             endof
\                $B0 of   .s" cmpxch  " 0 to size r/m,r   endof
\                $B1 of   .s" cmpxch  " 1 to size r/m,r   endof
\                $B2 of   .s" lss     " 1 to size r,r/m   endof
\                $B3 of   .s" btr     " 1 to size r/m,r   endof
\                $B4 of   .s" lfs     " 1 to size r,r/m   endof
\                $B5 of   .s" lgs     " 1 to size r,r/m   endof
\                $B6 of   .s" movzx   " 0 to size r,r/m   endof
\                $B7 of   .s" movzx   " 1 to size r,r/m   endof
\                $BA of   gp8                             endof
\                $BB of   .s" btc     " 1 to size r/m,r   endof
\                $BC of   .s" bsf     " 1 to size r,r/m   endof
\                $BD of   .s" bsr     " 1 to size r,r/m   endof
\                $BE of   .s" movsx   " 0 to size r,r/m   endof
\                $BF of   .s" movsx   " 1 to size r,r/m   endof
\                $C0 of   .s" xadd    " 0 to size r/m,r   endof
\                $C1 of   .s" xadd    " 1 to size r/m,r   endof
\                $C7 of   .s" cmpxchg8b " r/m16/32        endof
\                $C8 of   .s" bswap   eax "               endof
\                $C9 of   .s" bswap   ecx "               endof
\                $CA of   .s" bswap   edx "               endof
\                $CB of   .s" bswap   ebx "               endof
\                $CC of   .s" bswap   esp "               endof
\                $CD of   .s" bswap   ebp "               endof
\                $CE of   .s" bswap   esi "               endof
\                $CF of   .s" bswap   edi "               endof
\                ( else )  dup ???
\        endcase
\        ;
...
: dis-dd   cr .s" dd " @+ h.>s ;
: dis-ds   cr .s" string " $22 emit>s count 2dup >s + $22 emit>s ;

: dis  ( adr -- )
        begin
                dup
                cr inst
                key upc dup $1B = over ascii Q = or not
        while
                case
